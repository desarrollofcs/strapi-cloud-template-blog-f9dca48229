...
export interface ApiEmpleadoEmpleado extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    employeeCode: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    equipo: Schema.Attribute.Relation<'manyToOne', 'api::equipo.equipo'>;
    hireYear: Schema.Attribute.Integer;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vacationLog: Schema.Attribute.Component<'shared.registro-vacaciones', true>;
  };
}
...
export interface ApiEquipoEquipo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    manager: Schema.Attribute.Relation<'oneToOne', 'api::empleado.empleado'>;
    name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiMensajeFelicitacionMensajeFelicitacion
  extends Struct.CollectionTypeSchema {
  collectionName: 'mensajes_felicitaciones';
  info: {
    displayName: 'Mensaje de Felicitaci\u00F3n';
    pluralName: 'mensajes-felicitaciones';
    singularName: 'mensaje-felicitacion';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    from: Schema.Attribute.Relation<'manyToOne', 'api::empleado.empleado'>;
    isDismissed: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::mensaje-felicitacion.mensaje-felicitacion'
    > &
      Schema.Attribute.Private;
    message: Schema.Attribute.Text & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    to: Schema.Attribute.Relation<'manyToOne', 'api::empleado.empleado'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiNotificacionNotificacion
  ...
  attributes: {
    ...
    request: Schema.Attribute.Relation<
      'manyToOne',
      'api::solicitud-permiso.solicitud-permiso'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<'manyToOne', 'api::empleado.empleado'>;
  };
}
...
export interface ApiSolicitudPermisoSolicitudPermiso
  extends Struct.CollectionTypeSchema {
  collectionName: 'solicitudes_permisos';
  info: {
    displayName: 'Solicitud de Permiso';
    pluralName: 'solicitudes-permisos';
    singularName: 'solicitud-permiso';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    approvedLate: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    handoverTasks: Schema.Attribute.Component<'shared.tarea-delegada', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::solicitud-permiso.solicitud-permiso'
    ...
    status: Schema.Attribute.Enumeration<
      ['Pendiente', 'Aprobado', 'Rechazado', 'Cancelado', 'No Respondida']
    > &
      Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::mensaje-felicitacion.mensaje-felicitacion': ApiMensajeFelicitacionMensajeFelicitacion;
      'api::notificacion.notificacion': ApiNotificacionNotificacion;
      'api::proyecto.proyecto': ApiProyectoProyecto;
      'api::solicitud-permiso.solicitud-permiso': ApiSolicitudPermisoSolicitudPermiso;
